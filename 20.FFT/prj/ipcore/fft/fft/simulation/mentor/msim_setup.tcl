...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/visier/altera_lite/24.1std/quartus/"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twi1.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twr4.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twr1.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twi2.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twi3.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twr2.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twi4.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twr3.hex ./
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L fft_ii_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
